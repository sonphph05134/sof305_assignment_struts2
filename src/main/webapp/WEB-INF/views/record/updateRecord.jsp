                        ...
                        <section id="main-content">
                            <section class="wrapper">
                                ...
                                <div class="container">
                                    ...
                                    <div>&nbsp;</div>
                                    <h2><spring:message code="recordUpdate.title"/></h2>
                                    
                                    <!-- Begin Create screen -->
                                    <div>
							            <form action='<spring:url value="/record/updateRecord"></spring:url>' value="updateAction"></form>
							            <form:form action="${updateAction}" method="post" modelAttribute="recordUpdateForm">
							              <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="form-group">
                                                    <label for="code"><spring:message code="label.record.code"/>: </strong></label>
                                                ...
                                                <div class="form-group">
                                                    <label for="type"><spring:message code="label.record.type"/>: </label>
                                                    <div>
	                                            ...
	                                            <div class="form-group col">
	                                                <label for="reason"><spring:message code="label.record.reason"/>: </label>
